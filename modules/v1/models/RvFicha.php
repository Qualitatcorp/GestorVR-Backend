...
class RvFicha extends \yii\db\ActiveRecord
{
    ...
    public function timsEva1()
    {
        if($this->eva_id==54)
        {
            ...
            throw new \yii\web\HttpException(404, 'No se calculo de la nota psicologica porque la Evaluacion no es de TIMS.');
        }
    }
